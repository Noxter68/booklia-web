...
const ERROR_TRANSLATIONS: Record<string, string> = {
  ...
  'Booking must be ACCEPTED to start': 'Cette réservation doit d\'abord être acceptée',
  'Booking must be IN_PROGRESS to complete': 'Cette réservation doit d\'abord être démarrée',
