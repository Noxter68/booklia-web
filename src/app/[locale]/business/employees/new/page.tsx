...
const WEEK_DAYS = [
  { value: 0, labelKey: 'sunday', shortKey: 'sunShort' },
  { value: 1, labelKey: 'monday', shortKey: 'monShort' },
  { value: 2, labelKey: 'tuesday', shortKey: 'tueShort' },
  { value: 3, labelKey: 'wednesday', shortKey: 'wedShort' },
  { value: 4, labelKey: 'thursday', shortKey: 'thuShort' },
  { value: 5, labelKey: 'friday', shortKey: 'friShort' },
  { value: 6, labelKey: 'saturday', shortKey: 'satShort' },
];
  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-6">
        ...
        <h2 className="text-xl font-bold mb-1">{t('identityTitle')}</h2>
        <p className="text-muted-foreground text-sm">
          {t('identitySubtitle')}
        </p>
      </div>
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-sm text-muted-foreground">
                      {(service.priceCents / 100).toFixed(0)} &euro; &bull; {service.durationMinutes} min
                    </div>
                  </div>
                </motion.button>
              );
