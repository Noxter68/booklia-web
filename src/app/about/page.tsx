        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              Booklia est née d'une idée simple : faciliter les échanges de services entre particuliers
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                Nous avons créé Booklia pour répondre à un besoin simple : permettre à chacun
          ...
          >
            ...
            <div className="prose prose-lg dark:prose-invert mx-auto">
              <p className="text-muted-foreground leading-relaxed mb-6">
                Booklia est née d'un constat simple : dans notre quotidien, nous avons souvent besoin
              ...
              <p className="text-muted-foreground leading-relaxed">
                Aujourd'hui, Booklia grandit grâce à vous, notre communauté. Chaque service échangé
