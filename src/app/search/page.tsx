          ...
          <div className="p-4 pb-3 pt-25 border-b border-border space-y-2.5">
            ...
            <div className="relative">
              ...
              <Input
                ...
                placeholder="Que recherchez-vous ? (spa, coiffeur, manicure...)"
          ...
          <div ref={listRef} className="flex-1 overflow-y-auto">
            {isLoading ? (
              ...
              <div className="p-8 text-center">
                ...
                <p className="text-sm font-medium mb-1">Aucun professionnel trouve</p>
                <p className="text-xs text-muted-foreground mb-3">Essayez de modifier vos criteres de recherche</p>
                {hasActiveFilters && (
        ...
        <div className={`flex-1 relative min-h-0 ${showMobileMap ? 'block h-full w-full' : 'hidden md:block'}`}>
          {MAPBOX_TOKEN ? (
            ...
            <div className="w-full h-full flex items-center justify-center bg-muted/20">
              <p className="text-sm text-muted-foreground">Mapbox token manquant</p>
            </div>
          )}
